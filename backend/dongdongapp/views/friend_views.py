...
class FriendList(APIView):
    ...
    def post(self, request):  # 자신의 id(my), 친구 신청할 id(your), status(request)
        ...
        friend = Friend.objects.filter(Q(my_id=my_id, your_id=your_id, status="CONNECTING") | Q(
            my_id=your_id, your_id=my_id, status="CONNECTING"))
...
class FriendDetail(APIView):
    ...
    def get(self, request, user1):
        get_friends = Friend.objects.filter(
            my_id=user1, status="CONNECTING").all()
        test = []
    ...
    def delete(self, request, user1, user2):
        ...
        friend = Friend.objects.filter(
            Q(my_id=my_id, your_id=your_id) | Q(my_id=your_id, your_id=my_id))
...
class FriendDetail2(APIView):
    ...
    def get(self, request, user1):
        ...
        queryset = friends.select_related("your_id").values(
...
class FriendDetail4(APIView):
    ...
    def get(self, request, user1):
        ...
        queryset = friends.select_related(
